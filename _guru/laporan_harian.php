...
?>
    ...
    WHERE i.id_guru_piket = '$sesi' AND i.tanggal_izin BETWEEN '$_GET[tgl1]' AND '$_GET[tgl2]'
    ...
    WHERE k.id_guru_piket = '$sesi' AND k.tanggal BETWEEN '$_GET[tgl1]' AND '$_GET[tgl2]'
    ...
    <table class="table" width="100%" border="2" style="border-collapse: collapse;" cellpadding="3" cellspacing="0">
        ...
        <tbody>
            ...
            // PERBAIKAN ADA DI BAWAH INI (Bagian JOIN)
    ...
    <h3 class="tex"><b>Data Siswa Terlambat</b></h3>
