            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?= $data['tingkat']; ?></td>
                  <td>
                    <a href="?page=jurnal&idg=<?= $data['id_mapel']; ?>" class="btn btn-success" title="Isi Agenda Harian"> <span class="fa fa-book"></span> Jurnal</a>

                    <a href="?page=edit-mapel&id=<?= $data['id_mapel']; ?>" title="Edit" class="btn btn-warning"> <span class="fa fa-edit"></span></a>
                    <a href="?page=hapus-mapel&id=<?= $data['id_mapel']; ?>" title="Hapus" class="btn btn-danger"> <span class="fa fa-trash"></span></a>
                  </td>
                </tr>
              <?php
              }
