...
<div class="card">
    ...
    <div class="card-body">
        ...
        if (isset($_GET['bulan']) && isset($_GET['tahun'])) {
            ...
            $sql_agenda_lain = mysqli_query($con, "
            ...
            $sql_kehadiran_guru = mysqli_query($con, "
                SELECT COUNT(*) as jumlah 
                FROM tb_kehadiran_guru 
                WHERE MONTH(tanggal_kehadiran) = '$bulan' AND YEAR(tanggal_kehadiran) = '$tahun'
            ");
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $sql_detail = mysqli_query($con, "
                            ...
                            INNER JOIN tb_kelas k ON m.idkelas = k.idkelas
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $badge = ($row['status_izin'] == 'Disetujui') ? 'badge-success' : (($row['status_izin'] == 'Ditolak') ? 'badge-danger' : 'badge-warning');
                                    ?>
