...
$queryKeterlambatan = mysqli_query($con, "
    SELECT
        ...
        a.waktu_terlambat,
        a.keterangan,
        a.id_guru_piket, -- Ambil ID guru piket
        b.nis,
        b.nama_siswa,
        c.kelas, -- Ambil nama kelas dari tabel tb_kelas
        d.nama_guru -- Ambil nama guru dari tabel tb_guru
    FROM
        tb_keterlambatan a
    INNER JOIN
    ...
    LEFT JOIN
        tb_guru d ON a.id_guru_piket = d.id_guru -- Join ke tb_guru menggunakan id_guru_piket
    ORDER BY
    ...
    <div class="card-header">
        ...
        <tbody>
            ...
            while ($dataKeterlambatan = mysqli_fetch_array($queryKeterlambatan)) {
              ...
              // Tentukan nama guru piket
              $nama_guru_piket = $dataKeterlambatan['nama_guru'] ?? 'Admin/Tidak Diketahui';
            ?>
          <tr>
            <td><b> <?=$no++?>.</b> </td>
